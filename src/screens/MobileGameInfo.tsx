...
export function MobileCongestion({ value, rushing, recovery, recoverySeq = 0 }: { value: number; rushing: boolean; recovery?: GameState['stage']['congestionRecovery']; recoverySeq?: number }) {
