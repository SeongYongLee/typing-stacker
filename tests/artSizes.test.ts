...
const DRAWN: readonly (readonly [string, number, number])[] = [
  ...
  ['lucky-flowerpot', 0.646, 0.780],
  ['lunchbox-bear-omelet-rice', 0.700, 0.706],
  ['macaron', 0.470, 0.420],
  ['macaron-bear', 0.461, 0.470],
  ['magic-book', 0.502, 0.640],
  ...
  ['sketchbook', 0.437, 0.640],
  ['sketchbook-open', 0.600, 0.328],
  ['smartphone', 0.428, 0.640],
  ['smartwatch', 0.324, 0.500],
  ['snail', 0.700, 0.418],
  ['snail-curled', 0.560, 0.413],
  ['sneakers', 0.740, 0.507],
  ['snow-globe', 0.681, 0.780],
  ['snowflake', 0.651, 0.750],
  ['soccer-ball', 0.640, 0.632],
  ['space-poster', 0.615, 0.780],
  ['spaceship', 1.000, 1.128],
  ['spaceship-saucer', 0.990, 0.618],
  ['speaker', 0.586, 0.780],
  ['speed-course', 0.890, 0.661],
  ['spider-web', 0.640, 0.700],
  ['sports-trophy', 0.645, 0.780],
  ...
  ['vintage-trunk', 0.890, 0.645],
  ['washing-machine', 0.802, 0.940],
  ['watering-can', 0.740, 0.634],
  ['window', 0.787, 0.850],
  ['winged-wand', 0.360, 0.640],
  ['wooden-door', 0.676, 0.990],
